...
namespace SeaBreeze.Domain.Migrations
{
    ...
    [Migration("20230512062303_AddTablesForRealEstate")]
    partial class AddTablesForRealEstate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstateRealEstateFeature", b =>
                {
                    ...
                    b.ToTable("RealEstateRealEstateFeature");
                });
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.RealEsstates.RealEstateDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.RealEsstates.RealEstateFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.RealEsstates.RealEstateFeatureTranslates", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("RealEstateFeatureTranslates");
                });

            modelBuilder.Entity("SeaBreeze.Domain.Entity.RealEsstates.RealEstateGallery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RealEstateRealEstateFeature", b =>
                {
                    b.HasOne("SeaBreeze.Domain.Entity.RealEsstates.RealEstateFeature", null)
                        .WithMany()
