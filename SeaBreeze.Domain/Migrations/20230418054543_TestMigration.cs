    ...
    public partial class TestMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelEssentials", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HotelEssentialsId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelEssentialTranslate", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HotelEssentialTranslate_HotelEssentials_HotelEssentialsId",
                        column: x => x.HotelEssentialsId,
                        principalTable: "HotelEssentials",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "HotelHotelEssentials",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelHotelEssentials", x => new { x.EssentialsId, x.HotelsId });
                    table.ForeignKey(
                        name: "FK_HotelHotelEssentials_HotelEssentials_EssentialsId",
                        column: x => x.EssentialsId,
                        principalTable: "HotelEssentials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelHotelEssentials_Hotels_HotelsId",
                        column: x => x.HotelsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelHotelEssentials_HotelsId",
                table: "HotelHotelEssentials",
                column: "HotelsId");
        }
