...
namespace SeaBreeze.Domain.Migrations
{
    ...
    [Migration("20230506151509_AddingFieldsToBeachClubTicketsTable")]
    partial class AddingFieldsToBeachClubTicketsTable
    {
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.Tickets.BeachClubTicket", b =>
                {
                    ...
                    b.HasOne("SeaBreeze.Domain.Entity.Settings.Setting", "Settings")
                        .WithMany()
