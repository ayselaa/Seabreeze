...
namespace SeaBreeze.Domain.Migrations
{
    ...
    [Migration("20230531094905_AddPhoneNumberColumntoEntertainment")]
    partial class AddPhoneNumberColumntoEntertainment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.Entertainments.Entertainment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.Entertainments.EntertainmentImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EntertainmentImages");
                });

            modelBuilder.Entity("SeaBreeze.Domain.Entity.Entertainments.EntertainmentTranslate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EntertainmentTranslates");
                });
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.Localizations.StaticLocalizationTranslate", b =>
                {
                    ...
                    b.HasKey("Key", "LangCode");

                    b.ToTable("StaticLocalizationTranslates");
                });
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.Entertainments.EntertainmentImages", b =>
                {
                    b.HasOne("SeaBreeze.Domain.Entity.Entertainments.Entertainment", "Entertainment")
                        .WithMany("EntertainmentImages")
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.Entertainments.EntertainmentTranslate", b =>
                {
                    b.HasOne("SeaBreeze.Domain.Entity.Entertainments.Entertainment", null)
                        .WithMany("EntertainmentTranslates")
                        .HasForeignKey("EntertainmentId");
                });
            ...
            modelBuilder.Entity("SeaBreeze.Domain.Entity.Entertainments.Entertainment", b =>
                {
                    b.Navigation("EntertainmentImages");

                    b.Navigation("EntertainmentTranslates");
                });
